...
def load_imdb():
    ...
    print('test data: ')
    print(data_test[12])
    print(target_test[12])
    print(data_test[13])
    print(target_test[13])
    print(data_test[14])
    print(target_test[14])
...
def load_sst():
    ...
    data = []
    target = []
    with open('/home/hossein/Documents/DEC-keras-master/data/sst/data.txt') as data_file:
        for line in data_file:
            data.append(line.strip())
    with open('/home/hossein/Documents/DEC-keras-master/data/sst/label.txt') as target_file:
        for line in target_file:
            target.append(int(line.strip()))
    # max_len_sent = max(data, key=len)
    # max_len = len(max_len_sent.split())
